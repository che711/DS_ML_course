...
print(f"Создайте массив всех чётных чисел от 10 до 50 включительно: np.arange(0,51,2)-> {np.arange(0,51,2)}")  # просто добавляется шаг 2
...
print(f"\nОдно и то же случайное число -> {seed}")
